...
! GetCh() : char
!
! reads fromm the serial input to grab a single char and return
! it to the caller
! Built off of the Echo.s function provided, modified to only
! return a single char and put it in the stack
! 
GetCh:
		mov 	r15, r12
