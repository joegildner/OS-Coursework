...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   NEW CLASS Constructor...
!   ZeroMemory: _Global_mon = zeros  (sizeInBytes=48)
	set	_Global_mon,r4
	mov	12,r3
_Label_718:
	store	r0,[r4]
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   NEW CLASS Constructor...
!   ZeroMemory: forkLock = zeros  (sizeInBytes=20)
	load	[r14+8],r4
	add	r4,4,r4
	store	r0,[r4]
	store	r0,[r4+4]
...
!   Next value...
	...
	store	r1,[r14+-16]
_Label_580:
!   Data Move: *_temp_578 = 3  (sizeInBytes=4)
	mov	3,r1
	load	[r14+-20],r2
	store	r1,[r2]
!   _temp_578 = _temp_578 + 4
	...
	add	r1,4,r1
	store	r1,[r14+-20]
!   _temp_579 = _temp_579 + -1
	load	[r14+-16],r1
	add	r1,-1,r1
	store	r1,[r14+-16]
!   if intNotZero (_temp_579) then goto _Label_580
	load	[r14+-16],r1
	cmp	r1,r0
	bne	_Label_580
...
!   make sure array has size 5
	...
	bvs	_runtimeErrorOverflow
	bne	_runtimeErrorWrongArraySize
!   Data Move: *_temp_576 = *_temp_581  (sizeInBytes=24)
	load	[r14+-12],r5
	load	[r14+-48],r4
	load	[r5],r1
	store	r1,[r4]
...
!   _temp_595 = &status
	...
	add	r1,24,r1
	store	r1,[r14+-112]
!   Move address of _temp_595 [p ] into _temp_596
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_594 = *_temp_596  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-116]
!   if _temp_594 == 2 then goto _Label_593		(int)
	load	[r14+-116],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_593
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-92]
!   Data Move: _temp_600 = *_temp_602  (sizeInBytes=4)
	load	[r14+-92],r1
	load	[r1],r1
	store	r1,[r14+-100]
!   if _temp_600 != 3 then goto _Label_599		(int)
	load	[r14+-100],r1
	mov	3,r2
	cmp	r1,r2
	bne	_Label_599
!	_Label_598	jmp	_Label_598
_Label_598:
! THEN...
...
!   _temp_603 = &status
	...
	add	r1,24,r1
	store	r1,[r14+-88]
!   Move address of _temp_603 [p ] into _temp_604
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-84]
!   Data Move: *_temp_604 = 1  (sizeInBytes=4)
	mov	1,r1
	load	[r14+-84],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!   _temp_612 = &status
	...
	add	r1,24,r1
	store	r1,[r14+-72]
!   Move address of _temp_612 [p ] into _temp_613
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_611 = *_temp_613  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-76]
!   if _temp_611 != 1 then goto _Label_608		(int)
	load	[r14+-76],r1
	mov	1,r2
	cmp	r1,r2
	bne	_Label_608
!	_Label_610	jmp	_Label_610
_Label_610:
!   _temp_615 = &status
	load	[r14+8],r1
	add	r1,24,r1
...
!   _temp_616 = _temp_617 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-56]
!   Move address of _temp_615 [_temp_616 ] into _temp_618
!     make sure index expr is >= 0
	load	[r14+-56],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Data Move: _temp_614 = *_temp_618  (sizeInBytes=4)
	...
	load	[r1],r1
	store	r1,[r14+-64]
!   if _temp_614 == 2 then goto _Label_608		(int)
	load	[r14+-64],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_608
!	_Label_609	jmp	_Label_609
_Label_609:
!   _temp_620 = &status
	load	[r14+8],r1
	add	r1,24,r1
...
!   _temp_621 = _temp_622 rem 5		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-36]
!   Move address of _temp_620 [_temp_621 ] into _temp_623
!     make sure index expr is >= 0
	load	[r14+-36],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-28]
!   Data Move: _temp_619 = *_temp_623  (sizeInBytes=4)
	load	[r14+-28],r1
	load	[r1],r1
	store	r1,[r14+-44]
!   if _temp_619 == 2 then goto _Label_608		(int)
	load	[r14+-44],r1
	mov	2,r2
	cmp	r1,r2
	be	_Label_608
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-20]
!   Data Move: *_temp_660 = 3  (sizeInBytes=4)
	mov	3,r1
	load	[r14+-20],r2
	store	r1,[r2]
! SEND STATEMENT...
...
!   _temp_676 = 4		(4 bytes)
	...
	store	r1,[r14+-36]
!   Initialize FOR-LOOP index variable
!   Data Move: p = _temp_675  (sizeInBytes=4)
	load	[r14+-40],r1
	store	r1,[r14+-44]
_Label_671:
!   Perform the FOR-LOOP termination test
!   if p > _temp_676 then goto _Label_674		
	load	[r14+-44],r1
	load	[r14+-36],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
